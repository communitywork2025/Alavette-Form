...
<p align="center">
  <a href="#为什么选择-alavette-form">为什么选择</a> ·
...
**Alavette Form** 将原始 DOCX、处理方案、格式模板、母版和资料包组织在同一个桌面工作台中。已经确认的规则可以重复使用；正式处理前，应用会检查文档风险和资料完整性，再根据所选配置生成文档和报告。核心处理默认在本机完成，文档不会自动上传。
...
Alavette Form 适合需要重复执行 Word 排版规范、批量套用模板、生成交付版本或保留变更证据的个人与团队。它不是 Microsoft Word 的完整替代品，也不会在缺少明确规则时擅自改写原稿。
...
> [!NOTE]
> 当前仓库提供源码运行方式。安装版或便携版仅会在完成相应的打包、许可核对和发布验证后，通过 GitHub Releases 提供。
...
- 安全漏洞请通过 [GitHub Private vulnerability reporting](https://github.com/Alouetter/Alavette-Form/security/advisories/new) 私密报告，具体要求见 [SECURITY.md](SECURITY.md)。

## 常见问题

<details>
<summary><strong>Alavette Form 会覆盖原始文档吗？</strong></summary>
